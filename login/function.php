...
if(empty($_POST['signed'])){
    echo "<script>alert('Tanda Tangan Kosong ');window.location='index2';</script>";
}else{
    if($cek){
        ...
        echo "<script>alert('Pastikan No Anggota isi dengan benar. Jika Lupa minta bantuan petugas anda ! .');window.location='/';</script>";
    }
}
}
}
