...
$chmod = $chmenu5;
$anggota = mysqli_query($conn,"SELECT username, nama, alamat, kehadiran FROM tbl_anggota");
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Anggota KSP Dian Mandiri</h1>
                        </div>
                        <div class="col-sm-6">
									...
									?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href='editanggota.php?id_anggota=<?php echo $row['id_anggota'];?>' class="btn btn-primary btn-flat btn-xs"><i
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="function/fanggota.php?act=update"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <label
                                                                                class="col-sm-3 control-label text-left">Alamat<span
                                                                                    class="text-red"></span></label>
                                                                            <label
                                                                                class="col-sm-1 control-label text-rigth">:<span
                                                                                    class="text-red"></span></label>
