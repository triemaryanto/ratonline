                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td><img src="../anggota/ttd/ttd/<?php echo $row['ttd']; ?>" width="50px" height="50px"></td>
                                                    </tr>
                                                    <!-- modal delete -->
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="function/fanggota.php?act=update" method="POST" enctype="multipart/form-data">
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <input type="text" class="form-control" name="id_anggota" value="<?php echo $row['id_anggota']; ?>" hidden>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-7"><input type="text" class="form-control" name="username" value="<?php echo $row['username']; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <label class="col-sm-1 control-label text-rigth">:<span class="text-red"></span></label>
                                                                                        <div class="col-sm-7"><input type="text" class="form-control" name="nama" value="<?php echo $row['nama']; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <label class="col-sm-1 control-label text-rigth">:<span class="text-red"></span></label>
                                                                                        <div class="col-sm-7"><input type="text" class="form-control" name="kelompok" value="<?php echo $row['kelompok']; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <label class="col-sm-1 control-label text-rigth">:<span class="text-red"></span></label>
                                                                                        <div class="col-sm-7"><input type="text" class="form-control" name="po" value="<?php echo $row['po']; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
