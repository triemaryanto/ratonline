...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link">Tahun Buku 2022</a>
        </li>
                ...
                <form action="function/fuser.php?act=ubahpwd" method="POST" enctype="multipart/form-data">
                    ...
                    ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="id_user" value="<?php echo $row1['id_user']; ?>" hidden>
                            <input type="text" class="form-control" name="Username" value="<?php echo $row1['username']; ?>" readonly>
                            <h5 class="modal-title">Password</h5>
                            <input type="password" class="form-control" name="pass1" placeholder="Masukan Password Baru">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="undian.php" class="nav-link">
                        <i class="nav-icon fas fa-fw fa-gift"></i>
                        <p>
                            Undian
                        </p>
                    </a>
                ...
                <li class="nav-item">
                    <a href="dataundian.php" class="nav-link">
                        <i class="nav-icon fas fa-fw fa-database"></i>
                        <p>
                            Data Undian
                        </p>
                ...
                <li class="nav-item">
                    <a href="nominal.php" class="nav-link">
                        <i class="nav-icon fas fa-fw fa-cog"></i>
                        <p>
                            Kategori Nominal
                        </p>
