                                ...
                                <div class="card-body">
                                    <div class="card-tittle">
                                        <a href="#" class="btn btn-primary btn-flat btn-xs" data-toggle="modal"
                                            data-target="#tambah"><i class="fa fa-book"></i> Tambah User</a>
                                    </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="function/fuser.php?act=delete&id_user=<?php echo $row['id_user']; ?>&nama=<?php echo $row['nama'];?>"
                                                ...
                                                <div id="update<?php echo $no; ?>" class="modal fade" role="dialog"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="function/fuser.php?act=update"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <label
                                                                                class="col-sm-3 control-label text-right">Nama
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <label
                                                                                class="col-sm-3 control-label text-right">Username
                                                                                <span class="text-red"></span></label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control"
                                                                                    name="username"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <label
                                                                                class="col-sm-3 control-label text-right">Password
                                                                                <span class="text-red"></span></label>
                                                                            <div class="col-sm-8">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <datalist id="data">
                                                <select class="form-control">
                                                    <?php   
                                                    $query3 = mysqli_query($conn, "select * from tbl_anggota order by username esc");  
                                                    $result3 = mysqli_query($conn, "select * from tbl_anggota");  
                                                    $a          = "var nama = new Array();\n;";  
                                                    while ($row = mysqli_fetch_array($result3)) {  
                                                        echo '<option name="username" value="'.$row['username'] . '">' . $row['nama'] . '</option>';   
                                                    $a .= "nama['" . $row['username'] . "'] = {nama:'" . addslashes($row['nama'])."'};\n";  
                                                    }  
                                                    ?>
                                                </select>
                                            </datalist>
