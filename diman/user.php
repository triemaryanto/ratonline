                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="function/fuser.php?act=ubahpwd" method="POST" enctype="multipart/form-data">
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        <label class="col-sm-3 control-label text-right">Password
                                                                                            <span class="text-red"></span></label>
                                                                                        <div class="col-sm-8">
                                                                                            <input type="password" class="form-control" name="password" id="myInput2" value="">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        <label class="col-sm-3 control-label text-right">Ulangi Password
                                                                                            <span class="text-red"></span></label>
                                                                                        <div class="col-sm-8">
                                                                                            <input type="password" class="form-control" name="ulangi_password" id="myInput3" required>
                            ...
                            <form action="function/fuser.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label text-right">Ulangi Password
                                            <span class="text-red"></span></label>
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" name="ulangi_password" id="myInput1" required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label text-right"><span class="text-red"></span>Jabatan</label>
                                        <div class="col-sm-8">
                                            <select name="jab" class="form-control form-control-sm" required>
