                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Nominal</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="function/fnominal.php" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label>Nominal Baru</label>
                                                <input type="text" class="form-control" name="nominal" placeholder="Enter Nominal Rp....">
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Data Nominal</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 0;
                                                while ($row = mysqli_fetch_array($nominal)) {
                                                    $no++;
                                                ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo $row['nominal']; ?></a></td>
                                                        <td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="function/fnominal.php?act=delete&id=<?php echo $row['id']; ?>&nominal=<?php echo $row['nominal'] ?>" class="btn btn-primary">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h3 class="modal-title">Edit Nominal</h3>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form action="function/fnominal.php?act=update" method="POST" enctype="multipart/form-data">

                                                                            <input name="id" value="<?php echo $row['id']; ?>" hidden>
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    <label class="col-sm-3 control-label text-right">Nominal
