                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8"><input type="text" class="form-control"
                                                        name="userjabatan" value="<?php echo $data['userjabatan'] ?>"
                                                        Readonly></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Dasboard<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu1" value="<?php echo $data['menu1'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Materi RAT<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu2" value="<?php echo $data['menu2'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Kehadiran<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu3" value="<?php echo $data['menu3'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Tanggapan<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu4" value="<?php echo $data['menu4'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Data Anggota<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu5" value="<?php echo $data['menu5'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Question<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu6" value="<?php echo $data['menu6'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Manajemen User<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu7" value="<?php echo $data['menu7'] ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label text-right">Data Jabatan<span
                                                        class="text-red"></span></label>
                                                <div class="col-sm-8"><input type="number" class="form-control"
                                                        name="menu8" value="<?php echo $data['menu8'] ?>"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                Tulis angka 0 untuk hak akses tidak bisa semua .
                                    <br>
                                    Tulis angka 1 untuk hak akses baca .
                                    <br>
